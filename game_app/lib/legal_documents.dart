...
const String privacyConsentVersion = '2026-04-13';

const LegalDocumentContent privacyPolicyDocument = LegalDocumentContent(
  title: '隐私政策',
  summary:
      '2048 Solo 是一款离线单机益智游戏。当前版本不会要求你注册账号，也不会向开发者自建服务器上传你的游戏数据。',
  sections: [
    LegalSection(
      title: '我们会处理哪些信息',
...
const LegalDocumentContent userAgreementDocument = LegalDocumentContent(
  title: '用户协议',
  ...
  sections: [
    ...
    LegalSection(
      title: '知识产权',
      body:
          '应用中的代码、界面、图标、品牌文案及相关素材由开发者或合法授权方享有相应权利。未经许可，不得用于商业复制、转售或再分发。',
    ),
    LegalSection(
      title: '责任说明',
      body:
